...
*In addition to terrain, two types of structures also affect movement:  


| Structure          | EQ Movement Cost | Description |
|--------------------|--------------------------|-------------|
| `StructureWall`| 255 | Blocks Creep movement to this location until destroyed. |
| `StructureRoad`| 1  | Reduces movement cost to `1`, regardless of the original terrain being `PLAIN` or `SWAMP`. |  
